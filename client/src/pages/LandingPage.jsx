...
const LandingPage = () => {
  ...
  const words = [
    ...
    { text: "Out" },
    { text: "with" },
    { text: "AIpply.", className: "text-purple-600" },
  ];
    ...
    <AnimatePresence>
      {isVisible && (
        <>
          ...
          <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-indigo-50 to-purple-50 overflow-hidden relative">
            <div className="absolute inset-0 bg-[url('/grid-pattern.png')] opacity-5"></div>

            <div className="container mx-auto px-4 md:px-6 mb-6 sm:mb-8 md:mb-10 relative z-10">
              <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
